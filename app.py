...
def run():
    ...
    link = '[@Developed by Tamanna](https://www.linkedin.com/in/tamanna-bishnoi/)'
    ...
    if choice=='User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if 'Declaration'  in resume_text:
                    resume_score = resume_score + 20
                    st.markdown('''<h5 style='text-align: left; color: #1ed760;'>[+]You have added Delcaration/h4>''',unsafe_allow_html=True)
                else:
                ...
                if 'Hobbies' or 'Interests'in resume_text:
                    resume_score = resume_score + 20
                    st.markdown('''<h5 style='text-align: left; color: #1ed760;'>[+] You have added your Hobbies</h4>''',unsafe_allow_html=True)
                else:
                ...
                if 'Achievements' or 'Skills' in resume_text:
                    resume_score = resume_score + 20
                    st.markdown('''<h5 style='text-align: left; color: #1ed760;'>[+] You have added your Skills </h4>''',unsafe_allow_html=True)
                else:
                ...
                if 'Projects' in resume_text:
                    resume_score = resume_score + 20
                    st.markdown('''<h5 style='text-align: left; color: #1ed760;'>[+] You have added your Projects</h4>''',unsafe_allow_html=True)
                else:
        ...
        if st.button('Login'):
            if ad_user == 'tamanna' and ad_password == 'tamanna1':
